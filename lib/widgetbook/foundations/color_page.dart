...
//                 explicitOnColor: colors.onPrimaryNormal,
//               ),
//               _ColorInfo(
//                 name: 'secondary',
...
//             title: 'Surface',
//             children: _buildPairTiles([
//               _ColorInfo(name: 'background', color: colors.backgroundNormal),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isText ? context.colors.backgroundElevatedNormal : color,
